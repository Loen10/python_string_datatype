...
print("{0} {1} -was born in- {2}. {0} -enjoyed celebrating- {3}".format(my_first_name, my_last_name, my_year_of_birth, current_year))
...
print("{} {}".format(my_first_name, my_last_name).lower())
